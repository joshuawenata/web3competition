  ...
  useEffect(() => {
    ...
    if (items.length > 0) {
      items.forEach((item) => {
        if (
          !filterEnabled ||
          ((text.jenis === "jenis ciptaan" ||
            item.jenis_ciptaan === text.jenis) &&
            ...
            <div>
                ...
                <div className="flex flex-row place-content-start pl-10">
                    ...
                    >
                        ...
                        <option value="karya-drama-dan-koreografi">
                    ...
                    >
                        ...
                        <option value="saint_vincent_grenadines">
                        SAINT VINCENT DAN GRENADIN
                        </option>
